...
import { QuoteInfoFactory } from '../quote/quote-info/quote-info.factory';
...
@Component({
  ...
  templateUrl: './end-vendor.component.html',
  styleUrls: ['./end-vendor.component.css']
})
export class EndVendorComponent {
